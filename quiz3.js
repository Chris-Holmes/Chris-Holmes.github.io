...
var q5a1 = document.getElementById('q5a1'),
    ...
    finished = document.getElementById('completed');
...
q5a1.addEventListener("click", function() {
    ...
    //Finished course
        finished.textContent = "You've completed the course - well done!"
    
    //create New button
        var next = document.createElement("link");
        next.innerHTML="<a href='courses.html'>Courses</a>";
